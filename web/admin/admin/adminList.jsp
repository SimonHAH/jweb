	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
					...
					<c:forEach items="${page.adminList }" var="admin">
						<tr>
							<td height="20" bgcolor="#FFFFFF">
								<div align="center">
									<input type="checkbox" name="aid" id="aid" value="${admin.s_aid }" />
								</div>
							</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE6">
							<div align="center">
								<span class="STYLE19">${admin.s_aid}</span>
							</div>
						</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE19">
							<div align="center">${admin.s_username}</div>
						</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE19">
							<div align="center">${admin.s_password}</div>
						</td>
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE21">
								<%-- <a href="${pageContext.request.contextPath }/AdminServlet?op=deleteOne&aid=${admin.aid}">删除</a> | --%> 
								<a href="${pageContext.request.contextPath }/admin/admin/updateAdmin.jsp?aid=${admin.s_aid}&username=${admin.s_username}&password=${admin.s_password}">编辑</a>
							</div>
						</td>
					</tr>
					</c:forEach>
