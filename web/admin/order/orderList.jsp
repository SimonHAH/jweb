					...
					<c:forEach items="${page.orderList }" var="order">
						<tr>
							...
							<td height="15" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<span class="STYLE19">${order.s_oid}</span>
								</div>
							</td>
							<td height="5" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${order.s_money}</div>
							</td>
							<td height="8" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${order.s_recipients}</div>
							</td>
							<td height="10" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${order.s_tel}</div>
							</td>
							<td height="20" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${order.s_address}</div>
							</td>
							<td height="5" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${order.s_state}</div>
							</td>
							<td height="18" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${order.s_ordertime}</div>
							</td>
							...
							<td height="10" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									<a href="${pageContext.request.contextPath }/OrderServlet?op=delOrder&oid=${order.s_oid}">删除</a> |
									<a href="${pageContext.request.contextPath }/OrderServlet?op=orderDetail&oid=${order.s_oid}">查看</a>
								</div>
							</td>
					</tr>
					</c:forEach>
