...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">商品管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath}/CategoryServlet?op=findCategory&next=add" target="rightFrame">添加商品</a></li>
        <li><a href="${pageContext.request.contextPath}/ProductServlet?op=findAllProduct&num=1&next=inquire" target="rightFrame">查看/修改商品</a></li>
        <li><a href="${pageContext.request.contextPath}/CategoryServlet?op=findCategory&next=search" target="rightFrame">搜索商品</a></li>
      </ul>
    </li>
