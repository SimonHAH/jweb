					...
					<c:forEach items="${page.userList }" var="user">
						<tr>
							<td height="20" bgcolor="#FFFFFF">
								<div align="center">
									<input type="checkbox" name="aid" id="aid" value="${user.s_uid }" />
								</div>
							</td>
						<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10">${user.s_uid }</span>
							</div>
						</td>
						<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10">${user.s_username }</span>
							</div>
						</td>
						<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10">${user.s_nickname }</span>
							</div>
						</td>
						<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10">${user.s_password }</span>
							</div>
						</td>
						<td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10">${user.s_email }</span>
							</div>
						</td>
						<td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10">${user.s_birthday }</span>
							</div>
						</td>
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE21">无
							    <!-- 不让管理员修改用户资料  -->
 								<%-- <a href="${pageContext.request.contextPath }/UserServlet?uid=${user.uid}">编辑</a> --%> 
							</div>
						</td>
					</tr>
					</c:forEach>
