...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
					...
					<c:forEach items="${page.productList }" var="product">
						<tr>
							<td height="20" bgcolor="#FFFFFF">
								<div align="center">
									<input type="checkbox" name="pid" id="pid" value="${product.s_pid }" />
								</div>
							</td>
							<td height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<span class="STYLE19">${product.s_pid}</span>
								</div>
							</td>
							<td height="20" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${product.s_pname}</div>
							</td>
							<td height="20" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${product.s_estoreprice}</div>
							</td>
							<td height="20" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${product.s_markprice}</div>
							</td>
							<td height="20" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${product.s_pnum}</div>
							</td>
							<td height="20" bgcolor="#FFFFFF" class="STYLE19">
							...
							<td height="20" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									<a href="${pageContext.request.contextPath }/ProductServlet?op=deleteOne&pid=${product.s_pid}">删除</a> |
									<a href="${pageContext.request.contextPath }/CategoryServlet?op=findCategoryByUpdate&pid=${product.s_pid}">编辑</a>
								</div>
							</td>
					</tr>
					</c:forEach>
							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/ProductServlet?op=findAllProduct&num=1&next=inquire">首页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/ProductServlet?op=findAllProduct&num=${page.prevPageNum}&next=inquire">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/ProductServlet?op=findAllProduct&num=${page.nextPageNum}&next=inquire">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/ProductServlet?op=findAllProduct&num=${page.totalPageNum }&next=inquire">尾页</a></span>
										</div>
									</td>
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			window.location.href = "${pageContext.request.contextPath }/ProductServlet?op=findAllProduct&num="
					+ num+"&next=inquire";
