    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
			...
			<!-- 
				 ...
				 birthday
			 -->
			<form action="${pageContext.request.contextPath }/UserServlet?op=upDateUserInfo" method="post">
				<input type="hidden" name="uid" value="${user.s_uid }"/>
				用&nbsp;户&nbsp;名： <input type="text" name="username" readonly="true" value="${user.s_username }">
				<br /> <br />
				昵&nbsp;&nbsp;&nbsp;&nbsp;称：<input type="text" name="nickname" value="${user.s_nickname }">
				<br /><br />
				密&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="password" name="password" value="${user.s_password }"/>
				<br /><br />
				邮&nbsp;&nbsp;&nbsp;&nbsp;箱：<input type="text" name="email" value="${user.s_email }"/>
				<br /> <br />
				出生日期：<input type="text" name="birthday" value="${user.s_birthday}"/>
				<br /><br />
				<%--头像： ${user.s_headicon}--%>
				<%--<br /><br />--%>
