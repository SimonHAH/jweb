...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<img src="${product.s_imgurl }" style="width: 300px; height: 250px" /></a>
            </div>
            <div class="content_half float_r">
                <table>
                    <tr>
                        <td width="160">商城价格:</td>
                        <td>${product.s_estoreprice}</td>
                    </tr>
                    <tr>
                        <td>市场价格:</td>
                        <td>${product.s_markprice}</td>
                    </tr>
                    <tr>
                        <td>商品号:</td>
                        <td>${product.s_pid }</td>
                    ...
                    <tr>
                    	<td>购买数量:</td>
                        <td><input type="text" id="snum" value="1" style="width: 20px; text-align: right" />&nbsp;库存:${product.s_pnum }</td>
                    </tr>
                </table>
